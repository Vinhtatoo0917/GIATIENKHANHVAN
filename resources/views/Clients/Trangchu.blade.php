...
<section id="contact" class="py-16">
    <div class="max-w-7xl mx-auto px-4 md:px-6 text-center rounded-3xl border soft-card p-8 md:p-12 gold-ring"
        ...
        <div class="mt-7 flex flex-wrap gap-3 justify-center">
            <a href="tel:{{$thongtinlienhe->SDT}}" class="px-5 py-3 rounded-xl shadow-sm lift"
                style="background:var(--pink);color:#3d2a2e">
                📞 {{$thongtinlienhe->SDT}}
            </a>
            <a href="{{$thongtinlienhe->LINKFACEBOOK}}" target="_blank" rel="noopener noreferrer"
                class="px-5 py-3 rounded-xl border lift"
                style="border-color:var(--border);color:var(--muted)">
                Facebook Page
            </a>
        </div>
